...
contract TiendaVannesaDaou {
    ...
    function comprar(string memory nombreProducto) public 
        ...
        comprobarPagoExacto(calcularDescuento(msg.sender, productos[nombreProducto].precioUnitario))
        payable
    {
    ...
    function calcularDescuento(address cliente, uint precio) public view returns(uint)
    {
        ...
        comprobarInventario(nombreProducto)
    {
        ...
        uint precio = calcularDescuento(msg.sender, productos[nombreProducto].precioUnitario);
